...
const AppLayout = () => {
  ...
  const mtoPageUrls: any = ['/production-planning-scheduling/dynamic-release-mangement', "/production-planning-and-scheduling/due-date-quotation", "/poogi/insight-and-trends/otif-analysis", '/poogi/insight-and-trends/ot-and-if-analysis', '/manufacturing-intelligence-hub/improvement-areas/top-failure-reasons'];
