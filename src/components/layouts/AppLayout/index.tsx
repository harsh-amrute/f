...
const AppLayout = () => {
  ...
  let urlExcludePadding = ['/logistics/intransit-whereabouts', '/master-data-management/control-panel/view-modify', '/master-data-management/task-pending', '/master-data-management/control-panel/add', '/master-data-management/control-panel/delete', '/supply-chain-intelligence-hub/bpr', '/insights-and-trends/guided-insights', "/insights-and-trends/buffer-trend-report", '/insights-and-trends/research-insights', "/procurement/insights-and-trends/rmpm", "/procurement/insights-and-trends/rmpm-buffer-trends", "/procurement/insights-and-trends/rmpm-expediting-rm-suppliers", "/production-planning-and-scheduling/order-rescheduling", "/planning/simulative-fullkit", "/procurement-planning/planning", '/procurement/material-requirement', '/procurement/insights-and-trends/rmpm-orderwise-coverage', "/procurement/material-coverage-open-sales"];
  ...
  let urlExclusdeHeader = ['/procurement/material-coverage-open-sales', '/master-data-management/task-pending', '/master-data-management/task-status', '/master-data-management/saved-drafts', "/production-planning-scheduling/full-kit-assignment", '/production-planning-scheduling/insight-and-trends/order-at-risk', "/procurement-planning/planning", "/planning/simulative-fullkit", "/procurement/material-requirement", "/procurement/insights-and-trends/rmpm-orderwise-coverage", "/procurement/insights-and-trends/day-wise-coverage", "/procurement/insights-and-trends/rmpm-buffer-trends", "/procurement/insights-and-trends/rmpm-expediting-rm-suppliers"];
