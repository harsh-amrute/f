...
const AppLayout = () => {
  ...
  const mtoPageUrls: any = ["/mto/production/scheduling","/","/mto/master-data-management/control-panel/add","/mto/master-data-management/control-panel/view-modify","/mto/master-data-management/saved-drafts","/mto/master-data-management/task-status","/mto/master-data-management/task-pending","/mto/master-data-management/data-modification-history",'/master-data-management/mto-control-panel','/master-data-management/mto-control-panel/view-modify','/master-data-management/mto-saved-drafts','/master-data-management/mto-task-status','/master-data-management/mto-task-pending','/master-data-management/mto-control-panel/add', '/master-data-management/mto-control-panel/delete','/master-data-management/mto-control-panel/view-modify','/procurement/material-coverage-open-sales', '/production-planning-scheduling/insight-and-trends/order-at-risk', '/production-planning-scheduling/insight-and-trends/stpl-full-kits', '/production-planning-and-scheduling/order-rescheduling', '/planning/simulative-fullkit', '/procurement-planning/planning', '/procurement/material-coverage-open-sales', '/procurement/material-requirement', '/procurement/insights-and-trends/rmpm-orderwise-coverage', '/production-planning-scheduling/dynamic-release-mangement', "/production-planning-and-scheduling/due-date-quotation","/poogi/reasons-for-delayed-orders", "/poogi/insight-and-trends/otif-analysis", '/poogi/insight-and-trends/ot-and-if-analysis', '/production-planning-scheduling/insights-and-trends/elapsed-time', '/poogi/insight-and-trends/lead-time', '/poogi/insight-and-trends/trend-of-failure-reason', '/poogi/insight-and-trends/top-failure-reasons', "/manufacturing-intelligence-hub/delivery-performance/otif-analysis", "/manufacturing-intelligence-hub/delivery-performance/ot-and-if-analysis", "/manufacturing-intelligence-hub/delivery-performance/lead-time", "/manufacturing-intelligence-hub/congestion-analysis/elapsed-time", "/manufacturing-intelligence-hub/improvement-areas/top-failure-reasons", "/manufacturing-intelligence-hub/improvement-areas/trends-failure-reasons", "/production-planning-scheduling/overall-bm-report", "/production-planning-scheduling/deptwise-bm-report", "/landing-page"];
  ...
  let urlExclusdeHeader = ["/profile/bulk-upload" ,'/supply-chain-intelligence-hub/merchandising-grid', '/procurement/material-coverage-open-sales', '/mta/master-data-management/task-pending', '/mta/master-data-management/task-status', '/mta/master-data-management/saved-drafts', "/production-planning-scheduling/full-kit-assignment", '/production-planning-scheduling/insight-and-trends/order-at-risk', "/procurement-planning/planning", "/planning/simulative-fullkit", "/procurement/material-requirement", "/procurement/insights-and-trends/rmpm-orderwise-coverage", "/procurement/insights-and-trends/day-wise-coverage", "/procurement/insights-and-trends/rmpm-buffer-trends", "/procurement/insights-and-trends/rmpm-expediting-rm-suppliers", "/production-planning-scheduling/insight-and-trends/order-balance", "/production-planning-scheduling/enquiry-response", "/production-planning-and-scheduling/order-rescheduling", "/production-planning-scheduling/insight-and-trends/bm-trends", "/production-planning-scheduling/insight-and-trends/stpl-full-kits", "/production-planning-scheduling/insight-and-trends/order-balance", "/production-planning-scheduling/deptwise-bm-report", '/poogi/insight-and-trends/resource-utilization-wip-profile', "/production-planning-scheduling/insights-and-trends/fol-summary", "/poogi/reasons-for-delayed-orders", "/production-planning-scheduling/overall-bm-report", "/manufacturing-intelligence-hub/delivery-performance/bm-trends", "/manufacturing-intelligence-hub/congestion-analysis/orders-at-risk", "/manufacturing-intelligence-hub/congestion-analysis/order-balance", "/manufacturing-intelligence-hub/forward-exceution/fol-summary", "/manufacturing-intelligence-hub/forward-exceution/stpl-and-fullkit", "/manufacturing-intelligence-hub/forward-exceution/day-wise-coverage", "/manufacturing-intelligence-hub/forward-exceution/rm-pm-order-wise-coverage", "/manufacturing-intelligence-hub/forward-exceution/expetiting-rm-supplier", "/manufacturing-intelligence-hub/forward-exceution/rm-pm-buffer-trend", "/manufacturing-intelligence-hub/improvement-areas/resource-wip-profile"];
