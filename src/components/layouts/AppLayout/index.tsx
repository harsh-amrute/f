      ...
      <div className={GridSystem.SCGrid}>
        ...
        <div className={GridSystem.SCRow}>
          ...
          <div
            className={cx(
              baseCol8,
              urlExcludePadding.includes(location.pathname)
                ? paddingLeft0
                : paddingLeft50,
                zoom1
            )}
            // dynamic width stays inline since vanilla-extract is static
            style={{
              flex: `0 0 ${widthResponsive.widthRight}`,
              maxWidth: widthResponsive.widthRight,
            }}
          >
