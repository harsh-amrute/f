...
const AppLayout = () => {
  ...
  const mtoPageUrls: any = ['/procurement/material-coverage-open-sales', '/production-planning-scheduling/insight-and-trends/order-at-risk', '/production-planning-scheduling/insight-and-trends/stpl-full-kits', '/production-planning-and-scheduling/order-rescheduling', '/planning/simulative-fullkit', '/procurement-planning/planning', '/procurement/material-coverage-open-sales', '/procurement/material-requirement', '/procurement/insights-and-trends/rmpm-orderwise-coverage', '/production-planning-scheduling/dynamic-release-mangement', "/production-planning-and-scheduling/due-date-quotation", "/poogi/insight-and-trends/otif-analysis", '/poogi/insight-and-trends/ot-and-if-analysis', '/production-planning-scheduling/insights-and-trends/elapsed-time', '/poogi/insight-and-trends/lead-time', '/poogi/insight-and-trends/trend-of-failure-reason', '/poogi/insight-and-trends/top-failure-reasons', "/manufacturing-intelligence-hub/delivery-performance/otif-analysis", "/manufacturing-intelligence-hub/delivery-performance/ot-and-if-analysis", "/manufacturing-intelligence-hub/delivery-performance/lead-time", "/manufacturing-intelligence-hub/congestion-analysis/elapsed-time", "/manufacturing-intelligence-hub/improvement-areas/top-failure-reasons", "/manufacturing-intelligence-hub/improvement-areas/trends-failure-reasons", "/production-planning-scheduling/overall-bm-report", "/production-planning-scheduling/deptwise-bm-report"];
