...
const AppLayout = () => {
  ...
  const urlDisableZoomScaling = ['/supply-chain-intelligence-hub/planning','/insights-and-trends/research-insights','/insights-and-trends/buffer-trend-report','/insights-and-trends/guided-insights'];
