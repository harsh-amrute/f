...
const AppLayout = () => {
  ...
  const urlExclusdeHeader = ['/master-data-management/task-pending', '/master-data-management/task-status', '/master-data-management/saved-drafts', "/production-planning-scheduling/full-kit-assignment", '/production-planning-scheduling/insight-and-trends/order-at-risk', '/production-planning-scheduling/insight-and-trends/order-balance'];
