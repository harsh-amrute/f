...
const AppLayout = () => {
  ...
  let urlExclusdeHeader = ['/procurement/material-coverage-open-sales', '/master-data-management/task-pending', '/master-data-management/task-status', '/master-data-management/saved-drafts', "/production-planning-scheduling/full-kit-assignment", '/production-planning-scheduling/insight-and-trends/order-at-risk', "/procurement-planning/planning", "/planning/simulative-fullkit", "/procurement/material-requirement", "/procurement/insights-and-trends/rmpm-orderwise-coverage", "/procurement/insights-and-trends/day-wise-coverage", "/procurement/insights-and-trends/rmpm-buffer-trends", "/procurement/insights-and-trends/rmpm-expediting-rm-suppliers", "/production-planning-scheduling/insight-and-trends/order-balance"];
