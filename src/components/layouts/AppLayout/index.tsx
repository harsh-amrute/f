...
const AppLayout = () => {
  ...
  const mtoPageUrls: any = ['/production-planning-scheduling/dynamic-release-mangement', "/production-planning-and-scheduling/due-date-quotation", "/poogi/insight-and-trends/otif-analysis", '/poogi/insight-and-trends/ot-and-if-analysis', '/production-planning-scheduling/insights-and-trends/elapsed-time', '/poogi/insight-and-trends/lead-time', '/poogi/insight-and-trends/trend-of-failure-reason', '/poogi/insight-and-trends/top-failure-reasons'];
