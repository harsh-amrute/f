...
const BreadCrumb = () => {
  ...
  if (location.pathname === '/master-data-management/control-panel' || location.pathname === '/mto/master-data-management/control-panel') return <span>MDM <img src={"/assets/img/VectorFLOW/arrowbreadcrumb.svg"} alt="Arrow" height={11} width={11} /><BoldSpan> Control Panel</BoldSpan></span>
  if (location.pathname === '/master-data-management/control-panel/view-modify' || location.pathname === '/mto/master-data-management/control-panel/view-modify') return <span>MDM <img src={"/assets/img/VectorFLOW/arrowbreadcrumb.svg"} alt="Arrow" height={11} width={11} /><BoldSpan> View / Modify</BoldSpan></span>
  ...
  if (location.pathname === '/master-data-management/control-panel/add' || location.pathname === '/mto/master-data-management/control-panel/add') return <span>MDM <img src={"/assets/img/VectorFLOW/arrowbreadcrumb.svg"} alt="Arrow" height={11} width={11} /><BoldSpan> Add Records </BoldSpan></span>
  if (location.pathname === '/master-data-management/control-panel/delete' || location.pathname === '/mto/master-data-management/control-panel/delete') return <span>MDM <img src={"/assets/img/VectorFLOW/arrowbreadcrumb.svg"} alt="Arrow" height={11} width={11} /><BoldSpan> Delete Records </BoldSpan></span>
