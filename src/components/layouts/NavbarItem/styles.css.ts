...
export const mqLaptopMarginVar = createVar();
export const mqLaptopLMarginVar = createVar();
export const mqLaptopLPaddingVar = createVar();
export const mqLaptopLWidthVar = createVar();
...
globalStyle(`${SCNavMenu}.active .arrow::before`, {
  transform: "rotate(-45deg)",
});
globalStyle(`${SCNavMenu}.active .arrow::after`, {
  transform: "rotate(45deg)",
});
...
export const SCInterStoreArrowDown = style({
  ...
  "@media": {
    [mqLaptop]: { height: "6px", left: "20rem", position: "absolute" },
  },
});
...
export const SCItemChild = style({
  ...
  "@media": {
    [`screen and (min-width: ${gridSystem.size.laptopL}) and (max-width: ${gridSystem.size.desktop})`]:
      {
        margin: mqLaptopMarginVar,
      },

    [`screen and (min-width: ${gridSystem.size.laptop}) and (max-width: ${gridSystem.size.laptopL})`]:
      {
        fontSize: "1.2rem",
        margin: mqLaptopLMarginVar,
        padding: mqLaptopLPaddingVar,
        width: mqLaptopLWidthVar,
      },
  },
});
