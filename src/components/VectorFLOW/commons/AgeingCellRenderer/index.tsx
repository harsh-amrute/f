import { ageingCellRendererWrapper } from "./styles.css";
import React, { useState, CSSProperties } from "react";
import Portal from "../../layouts/Portal";

import { BPRViewTableToolTip } from "../../../../VectorFlow/Pages/MTA/SupplyChainIntelligenceHub/BPR/styles.css";

export const AgeingCellRenderer = (params: any) => {
  const [warningIcon, setWarningIcon] = useState(
    "/assets/img/VectorFLOW/BPR/ageing-warning.svg"
  );
  ...
  if (parseInt(params.data["AgeingOrder"], 10) > 0) {
    return (
      <>
        <div className={ageingCellRendererWrapper}>
          <img
            src={warningIcon}
            ...
            height={28}
            width={28}
            data-testid="ageing-warning-icon"
            alt="ageing warning"
          />
        </div>
        ...
        {isOpen && (
          <Portal wrapperId="viewtable">
            <div className={BPRViewTableToolTip}
              style={{
