...
/* runtime vars (set from TS) */
export const containerBgVar = createVar();
export const containerTextVar = createVar();
export const headerBorderVar = createVar();
...
/* container (theme-driven) */
export const BPRDailyAnalyticsContainer = style({
  display: "flex",
  flexDirection: "column",
  width: "90%",
  background: `var(${containerBgVar}, #383737)`,
  color: `var(${containerTextVar}, white)`,
...
export const BPRDailyAnalyticsHeader = style({
  color: "inherit",
  marginBottom: "6px",
  borderBottom: `1px solid var(${headerBorderVar}, white)`,
});
