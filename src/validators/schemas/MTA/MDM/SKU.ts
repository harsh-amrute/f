import Joi from "joi";
import { commonValidator, generateCommonMessages,defaultJOIOptions,MAX_CODE_LENGTH,MIN_DECIMAL_VAL,MAX_INT_VAL,MAX_NAME_LENGTH,MAX_DECIMAL_VAL,CommonSchema} from "../../../commons";
...
export const SKUSchema = Joi.object({
    ...
    sd:Joi.string().empty().max(MAX_NAME_LENGTH).messages(generateCommonMessages("Description")),
