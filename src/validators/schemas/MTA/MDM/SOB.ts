...
export const SOBSchema = Joi.object({
    ...
    sb:Joi.number().min(0.00).max(100.00).messages({'number.unsafe':`SOB should be within 1 to 100`,'number.min':"SOB should be within 1 to 100",'number.max':"SOB should be within 1 to 100"}),
