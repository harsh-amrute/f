...
import {useGetDBMNormSuggestionLoc,useGetDBMNormSuggestionPie, useGetDBMNormSuggestionSKUs, useGetDBMNormSuggestionAgeing}from "../../../../../Services/MTA/InsightsAndTrends";
            ...
            <SCDynamicContainer>
                    ...
                    <Allotment.Pane preferredSize={'50%'}>
                        <SCChartContainer height={547}>
                            <SCChartHeaderContainer>
                                <SCChartHeader>Top 10 Locations: Max No. of DBM Suggestions</SCChartHeader>
                            ...
                            <div style={{height:'460px',display:grid1DisplayStatus}}>
                                ...
                                {!hideChart1 && <div id="g1" style={{height:'460px'}}></div>}
                    ...
                    <Allotment.Pane>
                        <SCChartContainer height={547}>
                                ...
                                <div style={{height:'460px',display:grid2DisplayStatus}}>
                                  ...
                                  {!hideChart2 && <div id="g2" style={{height:'460px'}}></div>}
                ...
                <Allotment>
                    <Allotment.Pane>
                        <SCChartContainer height={547}>
                                <SCChartHeaderContainer>
                                    <SCChartHeader>Top 10 Products: Max No. of DBM Suggestions </SCChartHeader>
                                     {!hideChart3 && <img src="/assets/img/VectorFLOW/BPR/minimize.svg" alt="" data-testid="minimizechart3" onClick={()=>handleChartClose(3)}/>}
                                ...
                                <div style={{height:'570px',display:grid3DisplayStatus}}>
                                  ...
                                  {!hideChart3 && <div id="g3" style={{height:'460px'}}></div>}
                                <div id="graph3"></div>
                        </SCChartContainer>
                        <div style={{marginLeft:'10px',marginRight:'10px'}}>
                     ...
                     <Allotment.Pane>
                        <SCChartContainer height={547}>
                                <SCChartHeaderContainer>
                                    <SCChartHeader>Ageing categorization of DBM suggestions</SCChartHeader>
                                     {!hideChart4 && <img src="/assets/img/VectorFLOW/BPR/minimize.svg" alt="" data-testid="minimizechart4" onClick={()=>handleChartClose(4)}/>}
                                ...
                                <div style={{height:'570px',display:grid4DisplayStatus}}>
                                  ...
                                  {!hideChart4 && <div id="g4" style={{height:'460px'}}></div>}
                                <div id="graph4"></div>
                        </SCChartContainer>
                        <div style={{marginLeft:'10px',marginRight:'10px'}}>
