...
const ActionToolBar = ({
  ...
  const handleExportToExcel = () => {
    ...
    //   });
    // }
    else if(pathname==="/insights-and-trends/buffer-trend-report" || pathname=== "/supply-chain-intelligence-hub/bpr" || pathname=== "/supply-chain-intelligence-hub/rrr" || pathname==="/supply-chain-intelligence-hub/bor" || pathname==="/supply-chain-intelligence-hub/bor-color-bandwise" || pathname==="/supply-chain-intelligence-hub/rrr-color-bandwise"){
      onExportToExcelCallBack();
    }
    else{
      onExportToExcelOld({
