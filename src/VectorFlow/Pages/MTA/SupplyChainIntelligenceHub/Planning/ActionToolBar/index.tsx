        ...
        switch (currCategory) {
            case 'GITFromParent':
                return <VFMultiFilter
                    ...
                    supplyChainForLocationCheckBoxList={MultiFilterSupplyChainCheckboxList} supplyChainForChildrenOfCheckBoxList={MultiFilterSupplyChainCheckboxList}
                />;
            case 'GITToChild':
                return <VFMultiFilter
                    onApplyFilter={handleApplyFilter}
...

            {
                ...
                <SCTaskBarContainer>
                    ...
                    <SCCustomActionsContainer>
                        ...
                        {
                            (currCategory === 'CustomScreens' || currCategory === 'BufferTrend' || currCategory === "BPR" || currCategory === "RRR" || currCategory === "BOR" || currCategory === "BTR" || currCategory === "ResearchInsight" || currCategory === "DBMNorm" || (currCategory === "GuidedInsight" && currentTab !== "chronicunavailability") || currCategory === "OpenExpeditingRequests" || currCategory === "MaterialCov") ? null : (
                                !disableChartAndGridViewToggle &&
                                <SCViewBackground>
                                    <SCViewContainer onClick={() => {
                                        onViewChange('chart')
