...
/* runtime var to control SCChartContainer height at usage time */
...
export const SCChartContainer = style({
  ...
  marginBottom: 10,
  marginLeft: 5,
  height: chartHeightVar, // set via inline style; default to 'auto' in usage
});
...
export const SCChartHeader = style({
  ...
  color: '#000',
  textAlign: 'center',
  zoom: '0.7', // matches styled-components version
});
