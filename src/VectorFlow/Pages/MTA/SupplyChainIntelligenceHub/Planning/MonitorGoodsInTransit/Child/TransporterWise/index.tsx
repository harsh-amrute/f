...
const MonitorGITChildTransporterWise = ({
  data,
      ...
      <Allotment>
        <Allotment.Pane preferredSize={1000}>
          <div
            ...
            style={{ [chartHeightVar as any]: "547px" }}
          >
            <div className={SCChartHeaderContainer}>
              <p className={SCChartHeader}>
                Top 10 Transporters: Max LRs With On-Hand Black/Red SKUs Along
                With High Transport Ageing
              </p>
            </div>
