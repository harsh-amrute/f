...
const OrderFulfillmentLocationWise = ({data}:OrderFulfillmentProps) => {
    ...
    useEffect(()=>{
        ...
        console.log(formattedRowData1)
        setChartThemeOverridesG1(generateChartOptions(formattedRowData1,series1,palette1,'Location Name','No Of Orders',chartKeys1,undefined))
        ...
        console.log(formattedRowData2)
        setChartThemeOverridesG2(generateChartOptions(formattedRowData2,series2,palette2,'Location Name','NO Of SKUs',chartKeys2,undefined))
    },[])
