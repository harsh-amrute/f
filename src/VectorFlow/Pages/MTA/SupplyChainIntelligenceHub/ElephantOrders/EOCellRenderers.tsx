import {EOColorCellRendererWrapper} from './styles'
...
export const EODispatchColorCellRenderer = (params:any)=>{
    ...
    return(
        <EOColorCellRendererWrapper style={{backgroundColor:cellColor.bg,color:cellColor.text}}>
