import { BPRViewTableRowCell, BPRViewTableToolTip } from "./styles.css";
...
const BPRViewTableRowCellWithReadMore = (
  props: BPRViewTableRowCellWithReadMore
) => {
  const { value } = props;
  ...
  return (
    ...
    >
      ...
      <p
        style={{ color: "#BC3D81", cursor: "default" }}
