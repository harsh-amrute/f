...
const BPR = ()=>{
  ...
  const {
    ...
    return(
        <>
        <VFMultiFilter onApplyFilter={()=>console.log("")} onGoBack={()=>console.log("")} availabilityFilterActive={true} colorFilterActive={true} coverageFilterActive={true} horizonActive={true}></VFMultiFilter>
        <BPRLayout>
