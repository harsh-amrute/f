...
const JobViewIcon = (isSelected: boolean) => {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30">
        <g id="Job_View" data-name="Job View" transform="translate(-11017 -3258)">
          <path id="Path_17445" d="M0,0H30V30H0Z" transform="translate(11017 3258)" fill="none" />
          <path
            id="Path_17444"
  ...
  const gridViewJobIcon = (isSelected: boolean) => { 
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="20.603" height="20.604" viewBox="0 0 24.603 24.604">
        <path 
          id="job-description" 
  ...
  const resourceViewIcon = (isSelected: boolean) => {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 30 30">
        <g id="Resources_View" data-name="Resources View" transform="translate(-10977 -3258)">
          <rect
            id="Rectangle_16193"
  ...
  return (
    <ToolbarWrapper>
      ...
      <ToolbarRightSection>
        ...
        <VFButtonOutline style={{border: '1px solid rgb(188, 61, 129)', color: 'rgb(188, 61, 129)',fontSize: '1.1rem',height: '3.4rem'}} themeUi={themeUi} onClick={()=>{console.log("ExportExcel")}}>
            Export Excel
        </VFButtonOutline>
        ...
        <ToggleButtonWrapper>
          <ToggleButton onClick={()=>{setCurrentView("ResourceView")}}>
            ...
            <ButtonLabel isSelected={currentView==="ResourceView"}>Resource View</ButtonLabel>
          </ToggleButton>

          <ToggleDivider />

          <ToggleButton onClick={()=>{setCurrentView("JobView")}}>
            {JobViewIcon(currentView==="JobView")}
            <ButtonLabel isSelected={currentView==="JobView"}>Job View</ButtonLabel>
          </ToggleButton>
          <ToggleDivider />

          <ToggleButton onClick={onSelectClick}>
            {gridViewIcon(currentView==="GridViewR"|| currentView==="GridViewJ")}
            <ButtonLabel isSelected={currentView==="GridViewR"|| currentView==="GridViewJ"}>Grid View</ButtonLabel>
          </ToggleButton>
        </ToggleButtonWrapper>
      </ToolbarRightSection>
      ...
      {open && (
        <Portal wrapperId="checkbox-dropdown">
          <DropdownWrapper
            ...
            <ToggleButtonWrapper>
              <ToggleButton onClick={() => {setCurrentView("GridViewR");}}>
                {gridViewResourceIcon(currentView==="GridViewR")}
                <ButtonLabel isSelected={currentView==="GridViewR"}>Resource List</ButtonLabel>
              </ToggleButton>
              <ToggleDivider/>
              <ToggleButton onClick={() => {setCurrentView("GridViewJ");}}>
                {gridViewJobIcon(currentView==="GridViewJ")}
                <ButtonLabel isSelected={currentView==="GridViewJ"}>Job List</ButtonLabel>
              </ToggleButton>
            </ToggleButtonWrapper>
          </DropdownWrapper>
        </Portal>
