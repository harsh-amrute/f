...
const SchedulingActionToolbar = ({
  ...
  const selectedVars = (sel: boolean) =>
    assignInlineVars({
      [buttonLabelColorVar]: sel ? "rgb(188, 61, 129)" : "#3e3e3e",
      [buttonLabelWeightVar]: sel ? "600" : "400",
    });

  return (
    <div className={ToolbarWrapper}>
      <span className={ToolbarLeftSection}>
        <button className={GoBackButton} onClick={() => onGoBack()}>
          <img
      ...
      <span className={ToolbarRightSection}>
        ...
        <div className={ToggleButtonWrapper}>
          <button
            ...
            onClick={() => setCurrentView("ResourceView")}
          >
            {resourceViewIcon(currentView === "ResourceView")}
            <span
              className={ButtonLabel}
              style={selectedVars(currentView === "ResourceView")}
            >
              Resource View
            </span>
          </button>
          ...
          <button
            className={ToggleButton}
            onClick={() => setCurrentView("JobView")}
          >
            {JobViewIcon(currentView === "JobView")}
            <span
              className={ButtonLabel}
              style={selectedVars(currentView === "JobView")}
            >
              Job View
            </span>
          </button>
        ...
        <Portal wrapperId="checkbox-dropdown">
          ...
          >
            ...
            <div className={ToggleButtonWrapper}>
              <button
                className={ToggleButton}
                onClick={() => setCurrentView("GridViewR")}
              >
                {gridViewResourceIcon(currentView === "GridViewR")}
                <span
                  className={ButtonLabel}
                  style={selectedVars(currentView === "GridViewR")}
                >
                  Resource List
                </span>
              </button>
              ...
              <button
                className={ToggleButton}
                onClick={() => setCurrentView("GridViewJ")}
              >
                {gridViewJobIcon(currentView === "GridViewJ")}
                <span
                  className={ButtonLabel}
                  style={selectedVars(currentView === "GridViewJ")}
                >
                  Job List
                </span>
              </button>
