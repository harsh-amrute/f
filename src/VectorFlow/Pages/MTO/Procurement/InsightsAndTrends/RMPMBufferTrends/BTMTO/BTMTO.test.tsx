...
describe('BTMTO Component', () => {

    test('renders BTMTO component with isMTO prop as false', () => {
        render(contextWrapper(<BTMTO data={dummyData} isMTO={false} />, mockedStore));

        expect(screen.getByText(/Select Horizon/i)).toBeInTheDocument();
    });

    test('renders BTMTO component with isMTO prop as true', () => {
        render(contextWrapper(<BTMTO data={dummyData} isMTO={true} />, mockedStore));
