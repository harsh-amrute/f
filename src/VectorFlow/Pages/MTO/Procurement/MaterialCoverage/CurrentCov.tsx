...
const CurrentCov = ({
  ...
  const loadInitialData = () => {
    const totalOrdCunt: any = calculatePercentage(
      SOData,
      ColorsMTO.Black.label,
      ColorsMTO.Red.label,
      ColorsMTO.Yellow.label,
      ColorsMTO.Green.label,
      0
    );
    setTotalOrdeerCount(totalOrdCunt);

    const totalBlueOrdCount: any = calculatePercentage(
      SOData,
    ...
    const nthBlock: any = mapOrderDetails(
      SOData,
      ColorsMTO.Blue.label,
      ColorsMTO.White.label,
      "",
    ...
    const blackNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Black.label,
      "NK",
      0
    ...
    const blackPK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Black.label,
      "PK",
      0
    ...
    const blackFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Black.label,
      "FK",
      0
    ...
    const RedNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Red.label,
      "NK",
      0
    ...
    const RedPK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Red.label,
      "PK",
      0
    ...
    const RedFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Red.label,
      "FK",
      0
    ...
    const YellowNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Yellow.label,
      "NK",
      0
    ...
    const YellowPK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Yellow.label,
      "PK",
      0
    ...
    const YellowFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Yellow.label,
      "FK",
      0
    ...
    const GreenNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Green.label,
      "NK",
      0
    ...
    const GreenPK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Green.label,
      "PK",
      0
    ...
    const GreenFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Green.label,
      "FK",
      0
    ...
    const BlueNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Blue.label,
      "NK",
      1
    ...
    const WhiteNK = calculateColorOrderCount(
      SOData,
      ColorsMTO.White.label,
      "NK",
      1
    ...
    const BluePK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Blue.label,
      "PK",
      1
    ...
    const WhitePK = calculateColorOrderCount(
      SOData,
      ColorsMTO.White.label,
      "PK",
      1
    ...
    const BlueFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.Blue.label,
      "FK",
      1
    ...
    const WhiteFK = calculateColorOrderCount(
      SOData,
      ColorsMTO.White.label,
      "FK",
      1
  ...
  const setAnalyticalData = () => {
    const blackCount: any = mapOrderDetails(
      SOData,
      ColorsMTO.Black.label,
      "",
      "",
    ...
    const redCount: any = mapOrderDetails(
      SOData,
      ColorsMTO.Red.label,
      "",
      "",
    ...
    const yellowCount: any = mapOrderDetails(
      SOData,
      ColorsMTO.Yellow.label,
      "",
      "",
    ...
    const greenCount: any = mapOrderDetails(
      SOData,
      ColorsMTO.Green.label,
      "",
      "",
    ...
    const blueCount: any = mapOrderDetails(
      SOData,
      ColorsMTO.Blue.label,
      ColorsMTO.White.label,
      "",
    ...
    <div className={main}>
      ...
      <div className={mainContainer}>
        ...
        >
          ...
          <MTOMaterialSO
            kit={"No Kit"}
            colors={{
              c1: ColorsMTO.Black.code,
              c2: ColorsMTO.Red.code,
              c3: ColorsMTO.Yellow.code,
            }}
            height={"18px"}
            text={""}
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Bnk,
              c2: colorOrderCount?.Rnk,
              c3: colorOrderCount?.Ynk,
              p3: colorOrderCount?.Ynkp,
              p1: colorOrderCount?.Bnkp,
              p2: colorOrderCount?.Rnkp,
            }}
          />
        </div>
        <div
        ...
        >
          <MTOMaterialSO
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Bpk,
              c2: colorOrderCount?.Rpk,
              c3: colorOrderCount?.Ypk,
              p1: colorOrderCount?.Bpkp,
              p2: colorOrderCount?.Rpkp,
              p3: colorOrderCount?.Ypkp,
            }}
          />
        </div>
        <div
        ...
        >
          <MTOMaterialSO
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Bfk,
              c2: colorOrderCount?.Rfk,
              c3: colorOrderCount?.Yfk,
              p1: colorOrderCount?.Bfkp,
              p2: colorOrderCount?.Rfkp,
              p3: colorOrderCount?.Yfkp,
            }}
          />
        </div>
      </div>
      ...
      <div className={mainContainer}>
        ...
        <div
          className={box}
          onClick={() =>
            handleToggle(ColorsMTO.Green.label, "", "", "NK", "0", "0")
          }
        >
          <MTOMaterialSO
            kit={"No Kit"}
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Gnk,
              p1: colorOrderCount?.Gnkp,
            }}
          />
        </div>
        ...
        <div
          className={box}
          onClick={() =>
            handleToggle(ColorsMTO.Green.label, "", "", "PK", "0", "0")
          }
        >
          <MTOMaterialSO
            kit={"Partial Kit"}
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Gpk,
              p1: colorOrderCount?.Gpkp,
            }}
          />
        </div>
        ...
        <div
          className={box}
          onClick={() =>
            handleToggle(ColorsMTO.Green.label, "", "", "FK", "0", "0")
          }
        >
          <MTOMaterialSO
            kit={"Full Kit"}
            ...
            ToolTipdata={{
              c1: colorOrderCount?.Gfk,
              p1: colorOrderCount?.Gfkp,
            }}
          />
        </div>
      </div>
      ...
      <div className={mainContainer}>
        ...
        >
          <MTOMaterialSO
            ...
            ToolTipdata={{
              c3: colorOrderCount?.Blnk,
              c2: colorOrderCount?.Wnk,
              p3: colorOrderCount?.Blnkp,
              p2: colorOrderCount?.Wnkp,
            }}
          />
        </div>
        <div
