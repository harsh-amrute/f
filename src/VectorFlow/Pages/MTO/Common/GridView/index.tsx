...
const GridView = (props: IGridViewProps) => {
  ...
  const getGridData = async (params: any, page_Size?: any) => {
    try {
      ...
      const response = await getData({
        ...
        page_size: page_Size || userPageSize || pagination.mtoPageSize,
      });
  ...
  // Build a one-off style object with AG Grid CSS variables:
  const agPlanningCustomVars: React.CSSProperties = {
    // custom properties — cast keys to any to satisfy TS
    ...
    ["--ag-selected-row-background-color" as any]: "rgba(188, 61, 129, 0.2)",
