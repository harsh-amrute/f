        ...
        return `
           ...
           <div style="border-top: 1px dashed lightgray"></div>
            ...
            <div style="display:flex ;width: 100%; justify-content: space-around; color: lightgray">
              <span style="padding: 5px ">${datum?.black || '-' + datum?.red || '-'}</span>
              <span style="padding: 5px; margin-left: 30px; ">${datum?.black || '-'}</span>
        ...
        axes: [
          {
            type: "category",
            position: "left",
            title: { text: "Major | Minor Reasons", fontSize: 10, fontWeight: "bold" },
            label: {
              fontSize: 8,
              fontWeight: "bold",
              color: "black",
