...
/* dynamic var for progress width (e.g. "60%") */
export const availabilityPercentVar = createVar();
...
/* progress bar (width set via CSS var) */
export const BTRAvailabiltyCellRenderer = style({
  ...
  '::before': {
    ...
    left: 0,
    bottom: 0,
    width: availabilityPercentVar, // e.g. "67%"
    background:
