...
const WeekWiseGraph = ({
  ...
  const graph1 = [
    "This box plot graph highlights the trend of statistical distribution of elapsed time for the selected plant-department",
  ];
  ...
  const boxChartOptions: any = {
    ...
    chart: {
      ...
      toolbar: {
        ...
        tools: {
          download:
            '<img src="/assets/img/mto/RMPMBufferTrend/download.svg" class="ico-download" width="14">',
          customIcons: [],
        },
      },
      export: {
