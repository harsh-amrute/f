...
const FullKitAssignment = () => {
  ...
  return (
    <Wrapper>
      ...
      // }}
      />
      <VFPagination currentPage={currentPage} rowsPerPage={15} selectedRows={1} totalRows={totalRows} handleChangePage={handlePageChange} resetGridRef={currentGridRef} isDisabled={isDisabled}/>
