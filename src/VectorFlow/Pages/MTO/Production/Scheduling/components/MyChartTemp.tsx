...
import { CalendarBodyWrapper, CalendarCell, CalendarCellTop, CalendarHeaderRow, CalendarHeaderRowTop, CalendarHeaderWrapper, CalendarSection, CalendarTable, ChartWrapper, ColorPallete, ColumnBodyWrapper, ColumnHeaderRow, ColumnHeaderWrapper, ColumnSection, ColumnTable, ContentCell, ContentRow, HeaderCell, Label, LegendWrapper, ResizeHandle, SectionWrapper, TaskBar, TaskContainer, TooltipRow, TooltipWrapper, ZoomButton, ZoomButtonWrapper, ZoomSection } from "./MyChartStyles";
        ...
        <CalendarSection>
          <CalendarHeaderWrapper ref={rightHeaderRef}>
            ...
            <CalendarTable>
                    <thead>
            <CalendarHeaderRow>
                <CalendarCellTop style={{width: shiftFactor+'px', minWidth: shiftFactor+"px"}} key={"my"}>
                  &nbsp;
                    </CalendarCellTop>
                  {calendarHeaders.map((header: any, idx: any) => (
                    <CalendarCellTop style={{width: '300px', minWidth: '300px'}} key={idx} colSpan={header.subHeaders.length}>
                      {header.label}
                    </CalendarCellTop>
                  ))}
                </CalendarHeaderRow>
