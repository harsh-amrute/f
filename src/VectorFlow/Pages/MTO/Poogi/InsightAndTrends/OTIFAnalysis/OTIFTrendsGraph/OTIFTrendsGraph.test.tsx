...
describe('OTIFTrendsGraph Component', () => {
    ...
    test('renders without crashing', () => {
        render(contextWrapper(<OTIFTrendsGraph />,mockedStore));
        expect(screen.getByText('AgChartsReact Mock')).toBeInTheDocument();
    });

    test('displays the correct title', () => {
        render(contextWrapper(<OTIFTrendsGraph />,mockedStore));
        const title = screen.queryByTestId('ot-if-graph');
