...
import OTAndIFTrendsGraph from '.';
...
describe('OTAndIFTrendsGraph Component', () => {
    ...
    test('renders without crashing', () => {
        render(contextWrapper(<OTAndIFTrendsGraph />,mockedStore));
        expect(screen.getByText('AgChartsReact Mock')).toBeInTheDocument();
    });

    test('displays the correct title', () => {
        render(contextWrapper(<OTAndIFTrendsGraph />,mockedStore));
        const title = screen.queryByTestId('ot-and-if-graph');
