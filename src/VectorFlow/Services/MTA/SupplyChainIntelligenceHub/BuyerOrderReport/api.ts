...
export namespace SupplyChainIntelligenceHubService {
  ...
  export const getBORUIConfiguration = async () => {
    return await axios.get(process.env.REACT_APP_VF_API_HOST +`api/mta/BORUIConfig`);
  }
  ...
  export const getBORData = async (body:any) => {
    return await axios.post(process.env.REACT_APP_VF_API_HOST +`api/mta/BORData`, body, {
      headers: { 'Content-Type': 'application/json' }
    });
}
   ...
   export const getBORDataCount = async ( body:{filters:any,paginationParameter:{pageNumber:number,recordsPerPage:number}}) => {
    return await axios.post(process.env.REACT_APP_VF_API_HOST +`api/mta/BORDataCount`, body,{
      headers: { 'Content-Type': 'application/json' }
    });
  }

  export const getBORAnalyticsData = async () => {
    return await axios.get(process.env.REACT_APP_VF_API_HOST +`api/mta/BORAnalytics`,{
      headers: { 'Content-Type': 'application/json' }
    });
  }
